      ...
      <header className="h-14 px-4 sm:px-6 bg-slate-50/90 dark:bg-[#121212]/90 backdrop-blur-md border-b border-slate-200/80 dark:border-[#2A2A2A] flex items-center justify-between gap-2 sm:gap-3 shrink-0 z-20">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3 shrink-0">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-3 py-1.5 h-[34px] rounded-xl text-xs font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/[0.06] border border-slate-200/80 dark:border-[#2A2A2A] transition-colors cursor-pointer shrink-0"
            title="Chat History"
          >
            <History className="w-4 h-4 text-slate-500 shrink-0" />
            <span className="hidden sm:inline">History</span>
            <span className="px-1.5 py-0.5 rounded-full text-[10px] font-bold bg-slate-200 dark:bg-white/10 font-mono">
          ...
          <button
            ...
            className="w-[34px] h-[34px] rounded-xl inline-flex items-center justify-center text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-white/[0.06] border border-slate-200/80 dark:border-[#2A2A2A] transition-colors cursor-pointer shrink-0"
          ...
          <Button
            ...
            className="text-xs font-bold shadow-sm shadow-primary/25 shrink-0 whitespace-nowrap"
          >
            New Chat
          </Button>
        </div>
          ...
          {isThinking && (
            <div className="flex items-start gap-3 animate-in fade-in duration-200">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-[#141414] border border-slate-200/80 dark:border-[#2A2A2A] text-xs text-slate-600 dark:text-slate-300 flex items-center gap-2">
                ...
                <span>TRIXIE AI is analyzing revenue telemetry & formulating response...</span>
              </div>
            </div>
          )}
        ...
        <form onSubmit={handleSend} className="max-w-4xl mx-auto w-full space-y-2">
          ...
          <div className="relative flex items-end rounded-2xl bg-slate-50 dark:bg-[#181818] border border-slate-300/80 dark:border-[#2A2A2A] focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20 transition-all p-2 shadow-sm">
            ...
            <textarea
              ...
              placeholder="Ask TRIXIE AI to prospect leads, generate sequences, audit CRM, or trigger workflows..."
          ...
          <div className="flex items-center justify-between text-[11px] text-slate-400 px-1 font-medium">
            <span>TRIXIE AI has verified read/write access to your Deals CRM, Leads, and Mailboxes.</span>
