...
export const AutomationUseCasePage: React.FC = () => {
  // Flow Canvas State
  ...
  return (
    <div className="pt-24 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24 sm:space-y-32">
      <SEOHead 
        title="Sales Automation & Multi-Channel Sequence Engine | Outtricks"
        description="Automate manual data entry, verification multiAttributes, and multi-channel follow-ups on one connected platform."
        canonical="https://outtricks.com/use-cases/sales-automation"
        breadcrumbs={[{"name":"Use Cases","url":"/use-cases"},{"name":"Sales Automation","url":"/use-cases/sales-automation"}]}
      />
