  ...
  return (
    <div className="pt-24 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24 sm:space-y-32">
      ...
      <section className="space-y-8">
        ...
        <div className="bg-white dark:bg-[#141414] rounded-3xl border border-slate-200/90 dark:border-[#2A2A2A] shadow-xl overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs sm:text-sm">
              <thead>
                <tr className="border-b border-slate-200 dark:border-[#2A2A2A] bg-slate-50/70 dark:bg-[#181818]/60 font-sans text-xs">
                  <th className="py-4 px-6 text-slate-500 font-bold uppercase">Function / Capability</th>
                  <th className="py-4 px-6 bg-blue-50/80 dark:bg-white/[0.04] text-blue-600 dark:text-blue-400 font-extrabold border-x border-blue-100 dark:border-blue-900/60">
                    Outtricks
                  </th>
                  <th className="py-4 px-6 text-slate-700 dark:text-slate-300 font-bold">
                    Lemlist
                  </th>
                </tr>
              </thead>
                ...
                {FEATURE_ROWS.map((row, idx) => (
                  <tr key={idx} className="hover:bg-slate-50/60 dark:hover:bg-slate-800/40 transition-colors">
                    <td className="py-4 px-6 font-bold text-slate-900 dark:text-white">
                      <div className="text-xs text-blue-600 dark:text-blue-400 font-sans font-bold uppercase text-[10px]">
                        {row.domain}
                      </div>
                      <div>{row.feature}</div>
                    </td>
                    <td className="py-4 px-6 bg-blue-50/30 dark:bg-white/[0.04] font-bold text-slate-900 dark:text-white border-x border-blue-100 dark:border-blue-900/40">
                      <div className="flex items-center gap-2">
                        <Check className="w-4 h-4 text-emerald-500 shrink-0" />
                        <span>{row.outtricks}</span>
                      </div>
                    </td>
